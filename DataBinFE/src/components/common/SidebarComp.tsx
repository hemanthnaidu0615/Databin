...
export const SidebarComp = () => {
  ...
  const itemRenderer = (item: any) => {
    ...
    return (
      <a
        className={`sidebar-item flex items-center text-left px-2 py-6 m-1 text-purple-800 border-r-4 border-transparent ${
  ...
  const itemRenderer2 = (item: any) => {
    ...
    return (
      <a
        className={`flex items-center text-left p-5 m-1 text-slate-600 cursor-pointer ${
          isActive && "border-r-purple-800 text-white bg-purple-400"
  ...
  return (
    <div className="min-w-[5%] hover:min-w-[auto] transition-all duration-300 sidebar-container" style={{ width: 'auto' }}>
      <TieredMenu
        model={items}
        breakpoint="767px"
